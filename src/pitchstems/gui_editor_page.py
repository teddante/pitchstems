...
def build_editor_page(window) -> QWidget:
    ...
    editor_side_panel.setMinimumWidth(0)
    editor_side_panel.setMaximumWidth(policy.harmony_panel_width)
    editor_side_panel.setSizePolicy(QSizePolicy.Ignored, QSizePolicy.Expanding)
    ...
    chord_map_grid.setVerticalSpacing(4)
    chord_map_grid.addWidget(window.chord_view_mode, 0, 0, 1, 2)
    chord_map_grid.addWidget(window.chord_one_octave_button, 1, 0)
    chord_map_grid.addWidget(window.note_map_colours, 1, 1)
    editor_side.addLayout(chord_map_grid)
    editor_side.addWidget(window.chord_note_map_stack)
    editor_side.addWidget(window.chord_list, 1)

    theory_header = QGridLayout()
    theory_header.setHorizontalSpacing(6)
    theory_header.setVerticalSpacing(4)
    theory_header.addWidget(section_label("Theory Inspector"), 0, 0)
    theory_header.addWidget(window.show_chromatic_scales, 0, 1)
    theory_header.addWidget(window.inspect_theory_button, 1, 0, 1, 2)
